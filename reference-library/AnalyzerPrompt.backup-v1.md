...

{
  ...
  "post_classification": {
    ...
    "text_analysis": {
      ...
      "text_elements": [
        {
          "type": "headline | subheadline | tagline | brand-name | product-name | price | discount | promo | cta | benefits | ingredients | description | footer | badge",
          ...
          "estimated_purpose": "grab attention | communicate offer | brand identification | call to action | provide info"
        }
      ],
