# NANOBANANA GENERATE PROMPT TEMPLATE - VERSION 5 (STABLE)
...
| V5 | Added Rule 11: ASPECT RATIO 4:5 MANDATORY - NanoBanana must adapt composition without padding |
...
---
**Implemented in:** `agent.py` function `_build_nanobanana_prompt()` - VERSION 5 (STABLE)
