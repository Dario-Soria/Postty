...
{
  "type": "post_type_options",
  "text": "¡Excelente Foto! Veo que quieres lograr un post para tu producto de **crema Vichy 96h**. Estuve investigando mientras esperabas y estos son los **top tipos de ads para tu producto**, elige alguno para continuar con tu post por favor.",
  "productThumbnail": "/path/to/product.jpg",
  "postTypes": [
    {
      "type": "hero-shot",
      "label": "Hero Shot",
...
```json
{
  "type": "post_type_options",
  "text": "¡Excelente Foto! Veo que quieres lograr un post para tu producto de **crema Vichy 96h**. Estuve investigando mientras esperabas y estos son los **top tipos de ads para tu producto**, elige alguno para continuar con tu post por favor.",
  "productThumbnail": "/temp-uploads/product.jpg",
  "postTypes": [...]
}
```
...
{
  "type": "text",
  "text": "Perfecto, vamos a cambiar el modelo y mantener el mismo diseño.\n\nVeo que tu referencia tiene texto, aquí te doy algunas opciones de reemplazo:\n\n**Título:** Vichy 96h\n**Beneficios:** Piel hidratada 96 horas\n**Footer:** Podes encontrarnos en Nua@.com\n\n¿Te gustan las sugerencias? Podrías también decirme el texto exacto que quieres y lo edito sin problema!",
  "readyToGenerate": false
}
```
...
```
[TRIGGER_GENERATE_PIPELINE]
PRODUCT_IMAGE: /temp-uploads/product.jpg
REFERENCE_ID: b730eb4b-62fa-4b47-bc50-667253d6e264
PROMPT: Professional product photography of Vichy 96h cream with young male model applying product, clean white background, soft diffused lighting, premium beauty aesthetic, clear space at top 20% for text overlay
TEXT_CONTENT: ["Vichy 96h", "Piel hidratada 96 horas", "Nua@.com"]
ASPECT_RATIO: 4:5
```
...
**Example prompt:**
```
Professional beauty photography. Young male model with clear skin applying Vichy 96h cream to face. Clean white studio background with soft diffused lighting. Product bottle visible in frame. Full-length view with clear space at top 20% for text overlay. Premium beauty aesthetic with commercial advertising quality.
```
